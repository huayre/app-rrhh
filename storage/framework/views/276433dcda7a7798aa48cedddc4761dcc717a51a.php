                ...
                <table class="table table-bordered" id="tabla_platos">
                    ...
                    <?php $__currentLoopData = $platos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default p-1" onclick="eliminarEmpleado('<?php echo e($plato->id); ?>')"><i
...
<?php echo $__env->make('plantilla.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/platos/index.blade.php ENDPATH**/ ?>