...
<?php $__env->startSection('contenido'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-inline-block pt-3">
                            <div class="d-lg-flex">
                                <h2 class="mb-0"><?php echo e($numeroEmpleados); ?></h2>
            ...
            <div class="card caja">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-inline-block pt-3">
                            <div class="d-lg-flex">
                                <h2 class="mb-0"><?php echo e($numeroPostulantes); ?></h2>
                                <div class="d-flex align-items-center ml-lg-2">
                                    <i class="mdi mdi-clock text-muted"></i>
                                    <small class="ml-1 mb-0">Updated: 9:10am</small>
                                </div>
    ...
    <input type="hidden" value="<?php echo e($areas); ?>" id="areas">
    <input type="hidden" value="<?php echo e($vacantes); ?>" id="vacantes">
    <input type="hidden" value="<?php echo e($empleados); ?>" id="empleados">
...
<?php echo $__env->make('plantilla.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyectosistemasinformacion\app-rrhh\resources\views/inicio.blade.php ENDPATH**/ ?>