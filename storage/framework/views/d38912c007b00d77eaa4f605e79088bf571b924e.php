...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('template\vendors\simple-line-icons\css\simple-line-icons.css')); ?>">
...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center bg-dark navbar-brand-wrapper d-flex align-items-top justify-content-center">
            <a class="navbar-brand brand-logo" href="<?php echo e(route('inicio')); ?>"><img src="<?php echo e(asset('template\images\logo.svg')); ?>" alt="logo"></a>
            <a class="navbar-brand brand-logo-mini" href="<?php echo e(route('inicio')); ?>"><img src="<?php echo e(asset('template\images\logo-mini.svg')); ?>" alt="logo"></a>
        </div>
    ...
    <div class="container-fluid page-body-wrapper">
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link nav-link-hover" href="<?php echo e(route('inicio')); ?>">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-empleados">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(asset('empleado')); ?>">EMPLEADOS</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-areas">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('areas')); ?>">ÁREAS</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-convocatorias">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('postulante')); ?>">POSTULANTES</a></li>
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('vacante')); ?>">VACANTES</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-nomina">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('asistencia')); ?>">ASISTENCIA</a></li>
                            </ul>
                        </div>
                        <div class="collapse" id="sidebar-nomina">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('reporte')); ?>">REPORTE</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-funciones">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('funcion')); ?>">FUNCIONES</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-empleados">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(asset('cliente')); ?>">CLIENTES</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-reporte">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(asset('reporte-platos')); ?>">REPORTE PLATOS</a></li>
                            </ul>
                        </div>
                        <div class="collapse" id="sidebar-reporte">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(asset('reporte-pedidos')); ?>">REPORTE PEDIDOS</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
...
<script src="<?php echo e(asset('template\vendors\jquery-bar-rating\jquery.barrating.min.js')); ?>"></script>
<script src="<?php echo e(asset('template\vendors\chart.js\Chart.min.js')); ?>"></script>
<script src="<?php echo e(asset('template\vendors\raphael\raphael.min.js')); ?>"></script>
<script src="<?php echo e(asset('template\vendors\morris.js\morris.min.js')); ?>"></script>
<script src="<?php echo e(asset('template\vendors\jquery-sparkline\jquery.sparkline.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('template\vendors\flot\jquery.flot.categories.js')); ?>"></script>
<script src="<?php echo e(asset('template\vendors\flot\jquery.flot.fillbetween.js')); ?>"></script>
...
<script src="<?php echo e(asset('template\js\todolist.js')); ?>"></script>
<!-- endinject -->
...
<?php /**PATH C:\xampp\htdocs\xampp\Recurso Humanos - SI\app-rrhh\resources\views/plantilla/index.blade.php ENDPATH**/ ?>