    ...
    <div class="modal-dialog" role="document" style="max-width: 1000px">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <form id="formulario_cliente">
                <div class="row">
                   ...
                   <div>
                       <table class="table table-primary" style="margin: auto auto;width: 500px">
                           <thead>
                           <tr>
                               <th>PRODUCTO</th>
                               <th>PRECIO</th>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn_crear_cliente_mensaje" data-dismiss="modal">CANCELAR</button>
                <button type="button" class="btn btn-success" id="btn_crear_cliente" onclick="continuarPedido()">CONFIRMAR</button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /var/www/resources/views/web/create.blade.php ENDPATH**/ ?>